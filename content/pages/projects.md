...
This page presents description of some of the data projects I have been involved with.
...
## Estimation and analysis of finanial variance spillover networks for academic research
...
Then, after sampling and preparing selected data over a rolling time interval, [this repository](https://github.com/felixbrunner/euraculus) implements various **object-oriented programs (OOP)** to estimate **cross-validated regularized statistical learning algorithms**.
